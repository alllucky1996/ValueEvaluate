...
namespace Web.Areas.Management.Controllers
{
    ...
    public class DonViController : BaseController
    {
        ...
        #region load đơn vị theo đơn vị cha

        [Route("danh-muc-" + CRoute, Name = CName + "_List")]
        public async Task<ActionResult> List(long? IdDonViCha)
        {
            BaseView();
            if (IdDonViCha == null) RedirectToAction("Index");

            Expression<Func<DonVi, bool>> filter = o => o.IdCha == IdDonViCha;
